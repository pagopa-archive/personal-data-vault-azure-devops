...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ecs_deploy"></a> [ecs\_deploy](#module\_ecs\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy?ref=v2.0.5 |  |
...
|------|-------------|------|---------|:--------:|
| <a name="input_ms-person"></a> [ms-person](#input\_ms-person) | git repo ms-person service | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pdv-ms-tokenizer",<br>    "organization": "pagopa",<br>    "pipelines_path": "src/pipelines",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
